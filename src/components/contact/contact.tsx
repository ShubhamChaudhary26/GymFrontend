...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen mt-10 items-center justify-center bg-gray-100 dark:bg-zinc-950">
      {/* Left Form */}
      <div className="shadow-input h-[70vh]  my-12 w-full max-w-lg rounded-2xl bg-white px-8 py-10 dark:bg-black">
